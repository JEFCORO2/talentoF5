...
<head>
    ...
    <title>Talento F5 | Login </title><!--begin::Primary Meta Tags-->
                ...
                <form action="{{route('login')}}" method="POST">
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating"> 
                            <input id="loginEmail" type="email" class="form-control @error('email') is-invalid
                            @enderror" value="" placeholder="" name="email"> 
                    ...
                    <div class="input-group mb-1">
                        <div class="form-floating"> 
                            <input id="loginPassword" type="password" class="form-control @error('password') is-invalid
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <div class="d-grid gap-2"> <button type="submit" class="btn btn-primary">Iniciar Sesion</button> </div>
                        </div> <!-- /.col -->
                    </div> <!--end::Row-->
                </form>
